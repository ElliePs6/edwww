    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('κανονική άδεια', 'Κανονική Άδεια'), ('άδεια εξετάσεων εργαζόμενων σπουδαστών', 'Αδεια Εξετάσεων Εργαζόμενων Σπουδαστών'), ('άδεια εξετάσεων μεταπτυχιακών φοιτητών', 'Αδεια Εξετάσεων Μεταπτυχιακών Φοιτητών'), ('αιμοδοτική άδεια', 'Αιμοδοτική Άδεια'), ('άδεια άνευ αποδοχών', 'Άδεια Άνευ Αποδοχών'), ('άδεια μητρλοτητας', 'Άδεια Μητρότητας'), ('άδεια πατρότητας', 'Άδεια Πατρότητας')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Request', to='VacayVue.request')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='request_members', to=settings.AUTH_USER_MODEL)),
            ],
            options={
